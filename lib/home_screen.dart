...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _logout() async {
    ...
    // await prefs.remove('userToken'); // Xóa các dữ liệu người dùng khác đã lưu trữ
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // Có thể muốn làm cho AppBar trong suốt để thấy ảnh nền
        // backgroundColor: Colors.transparent,
        // elevation: 0,
      ),
      // Mở rộng body để chiếm toàn bộ không gian nếu AppBar trong suốt
      // extendBodyBehindAppBar: true,
      body: Container( // Thêm Container ở đây
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/background.jpg"), // Đã cập nhật đường dẫn hình ảnh
            fit: BoxFit.cover, // Chỉnh ảnh để che phủ toàn bộ Container
          ),
        ),
        child: Column(
          children: [
